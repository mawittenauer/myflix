...
kevin = User.create(full_name: "Kevin Wang", password: "password", email: "kevin@example.com", admin: true)

#Review.create(user: kevin, video: monk, rating: 5, content: "This is a really good movie!")
#
#Review.create(user: kevin, video: monk, rating: 2, content: "This is a horrible movie.")
